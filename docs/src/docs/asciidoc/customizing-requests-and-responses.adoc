...
[source,java,indent=0]
----
include::{examples-dir}/com/example/mockmvc/PreprocessingEveryTest.java[tags=setup]
----
...
[source,java,indent=0]
----
include::{examples-dir}/com/example/mockmvc/PreprocessingEveryTest.java[tags=use]
----
