...
public abstract class RestAssuredRestDocumentation {
	...
	/**
	 * Provides access to a {@link DocumentationConfigurationFilter} that can be used to
	 * configure Spring REST Docs using the given {@code restDocumentation}.
	 *
	 * @param restDocumentation the REST documentation
	 * @return the configuration filter
	 * @see RequestSpecification#filter(Filter)
	 */
	public static DocumentationConfigurationFilter documentationConfiguration(
			RestDocumentation restDocumentation) {
		return new DocumentationConfigurationFilter(restDocumentation);
	}
