...
public class SnippetConfigurer extends
		AbstractNestedConfigurer<DocumentationConfigurationFilter> {
	...
	SnippetConfigurer(DocumentationConfigurationFilter parent) {
		super(parent);
	}
	...
	void apply(FilterContext context) {
		((WriterResolver) context.getValue(WriterResolver.class.getName()))
				.setEncoding(this.snippetEncoding);
		context.setValue("org.springframework.restdocs.restassured.defaultSnippets",
