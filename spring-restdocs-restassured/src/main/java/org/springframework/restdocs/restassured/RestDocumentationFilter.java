...
public class RestDocumentationFilter implements Filter {
	...
	public Response filter(FilterableRequestSpecification requestSpec,
		...
		try {
			for (Snippet snippet : getSnippets(context)) {
	...
	private List<Snippet> getSnippets(FilterContext context) {
		List<Snippet> combinedSnippets = new ArrayList<>(
				(List<Snippet>) context
						.getValue("org.springframework.restdocs.restassured.defaultSnippets"));
